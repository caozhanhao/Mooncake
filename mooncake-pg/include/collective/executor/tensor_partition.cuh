#ifndef MOONCAKE_PG_COLLECTIVE_EXECUTOR_TENSOR_PARTITION_CUH
#define MOONCAKE_PG_COLLECTIVE_EXECUTOR_TENSOR_PARTITION_CUH
...
#endif  // MOONCAKE_PG_COLLECTIVE_EXECUTOR_TENSOR_PARTITION_CUH
